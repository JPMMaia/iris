...
namespace iris::json::operators
{
        ...
        export std::istream& operator>>(std::istream& input_stream, Soa_array_type& value)
        {
            JSON data{};
            input_stream >> data;
        ...
        export std::ostream& operator<<(std::ostream& output_stream, Soa_array_type const& value)
        {
            JSON const data = to_json(value);
        ...
        export std::istream& operator>>(std::istream& input_stream, Soa_array_view_type& value)
        {
            JSON data{};
            input_stream >> data;
        ...
        export std::ostream& operator<<(std::ostream& output_stream, Soa_array_view_type const& value)
        {
            JSON const data = to_json(value);
