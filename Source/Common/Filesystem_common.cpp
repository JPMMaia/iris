...
namespace iris::common
{
    ...
    std::filesystem::path get_share_path(std::filesystem::path const& relative_path)
    {
        ...
        std::filesystem::path const executable_directory_parent_include_path = get_executable_directory().parent_path().parent_path().parent_path().parent_path() / "share" / "iris" / relative_path;
