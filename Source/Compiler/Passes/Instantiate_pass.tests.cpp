...
@unique_name("Function_constructor__at__add__at__17767816870030916945")
function Function_constructor__at__add__at__17767816870030916945(first: Int32, second: Int32) -> (result: Int32)
{
    return first + second;
}

@unique_name("Function_constructor__at__add__at__13835038193234868660")
function Function_constructor__at__add__at__13835038193234868660(first: Float32, second: Float32) -> (result: Float32)
{
    return first + second;
}

@unique_name("Function_constructor__at__add__at__7997375056941093376")
function Function_constructor__at__add__at__7997375056941093376(first: Uint32, second: Uint32) -> (result: Uint32)
{
    return first + second;
}
...
function run() -> ()
{
    var a = Function_constructor__at__add__at__17767816870030916945(1, 2);
    var b = Function_constructor__at__add__at__13835038193234868660(3.0f32, 4.0f32);
    var c = Function_constructor__at__add__at__7997375056941093376(1u32, 2u32);
}
)";
...
@unique_name("Type_constructor__at__Dynamic_array__at__1921096279545076101")
struct Type_constructor__at__Dynamic_array__at__1921096279545076101
{
    data: *Float16 = null;
    length: Uint64 = 0u64;
}

@unique_name("Type_constructor__at__Dynamic_array__at__8796008789442667680")
struct Type_constructor__at__Dynamic_array__at__8796008789442667680
{
    data: *Int32 = null;
    length: Uint64 = 0u64;
}

function run(instance_0: Type_constructor__at__Dynamic_array__at__1921096279545076101) -> ()
{
    var instance_1: Type_constructor__at__Dynamic_array__at__8796008789442667680 = {};
}
)";
...
struct My_array
{
    data: Type_constructor__at__Dynamic_array__at__8796008789442667680 = {};
}
)";
...
function run(value: *Int32) -> ()
{
    iris.json__at__print_json__at__11944091517957075316(value);
}
...
@unique_name("iris.json__at__to_json__at__14337162453210386423")
function iris.json__at__to_json__at__14337162453210386423(value: *Int32) -> ()
{
    iris.json.use_internal();
    am.foo();
}

@unique_name("iris.json__at__print_json__at__11944091517957075316")
function iris.json__at__print_json__at__11944091517957075316(value: *Int32) -> ()
{
    iris.json__at__to_json__at__14337162453210386423(value);
}
)";
...
@unique_name("json_usage__at__to_json__at__15538507724022955306")
function json_usage__at__to_json__at__15538507724022955306(value: *Int32) -> ()
{
}
...
@unique_name("json_usage__at__print_json__at__4838214516180769282")
function json_usage__at__print_json__at__4838214516180769282(value: *Int32) -> ()
{
    json_usage__at__to_json__at__15538507724022955306(value);
}

export function run(value: *Int32) -> ()
{
    json_usage__at__print_json__at__4838214516180769282(value);
}
)";
...
function run(value: *Int32) -> ()
{
    iris.json_nested__at__to_json__at__7014527333063429389(value);
}

@unique_name("iris.json_nested__at__to_json__at__7014527333063429389")
function iris.json_nested__at__to_json__at__7014527333063429389(value: *Int32) -> ()
{
    if true
    {
...
function run(value: *Int32) -> ()
{
    iris.json_recursive__at__to_json__at__12744411881746136702(value);
}
...
@unique_name("iris.json_recursive__at__to_json__at__12744411881746136702")
function iris.json_recursive__at__to_json__at__12744411881746136702(value: *Int32) -> ()
{
...
function run(value: *Int32) -> ()
{
    iris.json_nested__at__print_json__at__15638429719736336031(value);
}
...
@unique_name("iris.json_nested__at__print_json__at__15638429719736336031")
function iris.json_nested__at__print_json__at__15638429719736336031(value: *Int32) -> ()
{
...
@unique_name("Test__at__foo__at__13299378529032138137")
function Test__at__foo__at__13299378529032138137(value: Float32) -> ()
{
}

var bar = Test__at__foo__at__13299378529032138137;
)";
...
var bar = iris.functions__at__to_json__at__822345616742601800;

@unique_name("iris.functions__at__to_json__at__822345616742601800")
function iris.functions__at__to_json__at__822345616742601800(value: *Int32) -> ()
{
}
)";
...
var bar: function<(value: Float32) -> ()> = Test__at__foo__at__13299378529032138137;
)";
...
var bar: function<(value: *Int32) -> ()> = iris.functions__at__to_json__at__822345616742601800;
...
@unique_name("Test__at__Vector3__at__9154931941353184484")
struct Test__at__Vector3__at__9154931941353184484
{
...
@unique_name("Test__at__Transform__at__15889164068375548787")
struct Test__at__Transform__at__15889164068375548787
{
    translation: Test__at__Vector3__at__9154931941353184484 = {};
    scale: Test__at__Vector3__at__9154931941353184484 = {};
}

using Transformf32 = Test__at__Transform__at__15889164068375548787;
)";
...
@unique_name("Test__at__Hash_map_node__at__16012875981245960104")
struct Test__at__Hash_map_node__at__16012875981245960104
{
    key: Uint64 = {};
    value: Uint64 = {};
}
...
@unique_name("Test__at__Hash_map__at__12744662031646597179")
struct Test__at__Hash_map__at__12744662031646597179
{
    slots: Soa_array_view::<mutable Test__at__Hash_map_node__at__16012875981245960104> = {};
    count: Uint64 = 0u64;
    capacity: Uint64 = 0u64;
}
...
@unique_name("Test__at__create_hash_map__at__10328779258422446284")
function Test__at__create_hash_map__at__10328779258422446284(capacity: Uint64, allocator: *Allocator) -> (map: Test__at__Hash_map__at__12744662031646597179)
{
    var slots_size_bytes = calculate_soa_array_size_bytes::<Test__at__Hash_map_node__at__16012875981245960104>(capacity);
    var memory = allocator->allocate(slots_size_bytes, 8u64);
    var slots_raw_memory = reinterpret_as::<*mutable Void>(memory);
    var slots = create_soa_array_view_from_pointer::<Test__at__Hash_map_node__at__16012875981245960104>(slots_raw_memory, slots_size_bytes);
...
function run() -> ()
{
    var hash_map = Test__at__create_hash_map__at__10328779258422446284(1u64, null);
}
)";
