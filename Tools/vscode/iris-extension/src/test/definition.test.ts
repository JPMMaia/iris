...
suite("Should get definition location of structs", () => {
    ...
    test.skip("Gets definition location of itself", async () => {
        const document_uri = get_document_uri("projects/other/definition_struct_0.iris");
        await test_definitions(document_uri, new vscode.Position(2, 9), [
            new vscode.Location(get_document_uri("projects/other/definition_struct_0.iris"), to_range(2, 7, 2, 16))
        ]);
    });
    ...
    test("Gets definition location of struct member 0 at instantiate expression", async () => {
        const document_uri = get_document_uri("projects/other/definition_struct_1.iris");
        await test_definitions(document_uri, new vscode.Position(11, 9), [
            new vscode.Location(get_document_uri("projects/other/definition_struct_1.iris"), to_range(4, 4, 4, 5))
        ]);
    });
    ...
    test("Gets definition location of struct member 1 at instantiate expression", async () => {
        ...
        await test_definitions(document_uri, new vscode.Position(12, 8), [
            new vscode.Location(get_document_uri("projects/other/definition_struct_1.iris"), to_range(5, 4, 5, 5))
        ]);
    });

    test("Gets definition location of struct member 2 at instantiate expression", async () => {
        const document_uri = get_document_uri("projects/other/definition_struct_2.iris");
        await test_definitions(document_uri, new vscode.Position(14, 21), [
            new vscode.Location(get_document_uri("projects/other/definition_struct_2.iris"), to_range(5, 4, 5, 5))
        ]);
    });

    test("Gets definition location of struct member at access expression 0", async () => {
        const document_uri = get_document_uri("projects/other/definition_struct_3.iris");
        await test_definitions(document_uri, new vscode.Position(11, 21), [
            new vscode.Location(get_document_uri("projects/other/definition_struct_3.iris"), to_range(4, 4, 4, 5))
        ]);
    });
    ...
    test("Gets definition location of struct member at access expression 2", async () => {
        ...
        await test_definitions(document_uri, new vscode.Position(12, 21), [
            new vscode.Location(get_document_uri("projects/other/definition_struct_3.iris"), to_range(5, 4, 5, 5))
        ]);
    });

    test("Gets definition location of struct at struct member type", async () => {
        const document_uri = get_document_uri("projects/other/definition_struct_4.iris");
        await test_definitions(document_uri, new vscode.Position(4, 11), [
            new vscode.Location(get_document_uri("projects/other/definition_struct_4.iris"), to_range(2, 7, 2, 16))
        ]);
    });
});
...
suite("Should get definition location of unions", () => {
    ...
    test.skip("Gets definition location of itself", async () => {
        const document_uri = get_document_uri("projects/other/definition_union_0.iris");
        await test_definitions(document_uri, new vscode.Position(2, 6), [
            new vscode.Location(get_document_uri("projects/other/definition_union_0.iris"), to_range(2, 6, 2, 14))
        ]);
    });
    ...
    test("Gets definition location of union member at instantiate expression 0", async () => {
        ...
        await test_definitions(document_uri, new vscode.Position(11, 8), [
            new vscode.Location(get_document_uri("projects/other/definition_union_0.iris"), to_range(4, 4, 4, 5))
        ]);
    });
    ...
    test("Gets definition location of union member at instantiate expression 1", async () => {
        ...
        await test_definitions(document_uri, new vscode.Position(16, 8), [
            new vscode.Location(get_document_uri("projects/other/definition_union_0.iris"), to_range(5, 4, 5, 5))
        ]);
    });
    ...
    test("Gets definition location of union member at instantiate expression 3", async () => {
        const document_uri = get_document_uri("projects/other/definition_union_1.iris");
        await test_definitions(document_uri, new vscode.Position(14, 11), [
            new vscode.Location(get_document_uri("projects/other/definition_union_1.iris"), to_range(4, 4, 4, 5))
        ]);
    });
    ...
    test("Gets definition location of union member at instantiate expression 4", async () => {
        ...
        await test_definitions(document_uri, new vscode.Position(14, 22), [
            new vscode.Location(get_document_uri("projects/other/definition_union_1.iris"), to_range(5, 4, 5, 5))
        ]);
    });
...
suite("Should get definition location of functions", () => {
    ...
    test("Gets definition location of function name 0", async () => {
        const document_uri = get_document_uri("projects/other/definition_function_0.iris");
        await test_definitions(document_uri, new vscode.Position(9, 12), [
            new vscode.Location(get_document_uri("projects/other/definition_function_0.iris"), to_range(2, 9, 2, 12))
        ]);
    });

    test("Gets definition location of function name 1", async () => {
        const document_uri = get_document_uri("projects/other/definition_function_1.iris");
        await test_definitions(document_uri, new vscode.Position(17, 11), [
            new vscode.Location(get_document_uri("projects/other/definition_function_1.iris"), to_range(8, 9, 8, 12))
        ]);
    });
    ...
    test.skip("Gets definition location of function input parameter name 0", async () => {
        ...
        await test_definitions(document_uri, new vscode.Position(2, 13), [
            new vscode.Location(get_document_uri("projects/other/definition_function_0.iris"), to_range(2, 13, 2, 16))
        ]);
    });
    ...
    test.skip("Gets definition location of function input parameter name 1", async () => {
        ...
        await test_definitions(document_uri, new vscode.Position(2, 28), [
            new vscode.Location(get_document_uri("projects/other/definition_function_0.iris"), to_range(2, 25, 2, 28))
        ]);
    });
...
suite("Should get definition location of enums", () => {
    ...
    test.skip("Gets definition location of enum at itself", async () => {
        const document_uri = get_document_uri("projects/other/definition_enum_0.iris");
        await test_definitions(document_uri, new vscode.Position(2, 5), [
            new vscode.Location(get_document_uri("projects/other/definition_enum_0.iris"), to_range(2, 5, 2, 12))
        ]);
    });
    ...
    test("Gets definition location of enum value 0", async () => {
        ...
        await test_definitions(document_uri, new vscode.Position(11, 20), [
            new vscode.Location(get_document_uri("projects/other/definition_enum_0.iris"), to_range(4, 4, 4, 11))
        ]);
    });
    ...
    test("Gets definition location of enum value 1", async () => {
        ...
        await test_definitions(document_uri, new vscode.Position(12, 27), [
            new vscode.Location(get_document_uri("projects/other/definition_enum_0.iris"), to_range(5, 4, 5, 11))
        ]);
    });
    ...
    test("Gets definition location of enum value 2", async () => {
        const document_uri = get_document_uri("projects/other/definition_enum_0.iris");
        await test_definitions(document_uri, new vscode.Position(13, 23), [
            new vscode.Location(get_document_uri("projects/other/definition_enum_0.iris"), to_range(6, 4, 6, 11))
        ]);
    });
});
...
suite("Should get definition location of global variables", () => {
    ...
    test.skip("Gets global variable definition location of itself", async () => {
        const document_uri = get_document_uri("projects/other/definition_global_variable_0.iris");
        await test_definitions(document_uri, new vscode.Position(2, 6), [
            new vscode.Location(get_document_uri("projects/other/definition_global_variable_0.iris"), to_range(2, 4, 2, 22))
        ]);
    });
    ...
    test("Gets definition location of define when used as expression", async () => {
        const document_uri = get_document_uri("projects/project_1/definition_global_variable_0.iris");
