...
suite("Should display function signature", () => {
    test("Should show function signature with first parameter selected, and documentation 0", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_function_0.iris');
    ...
    test("Should show function signature with first parameter selected, and documentation 1", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_function_1.iris');
    ...
    test("Should show function signature with second parameter selected, and documentation 0", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_function_2.iris');
    ...
    test("Should show function signature with second parameter selected, and documentation 1", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_function_3.iris');
    ...
    test("Should show function signature of imported function", async () => {
        const document_uri = get_document_uri('projects/project_1/signature_help_function_0.iris');
...
suite("Should display struct signature", () => {
    test("Should show struct signature 0", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_0.iris');
    ...
    test("Should show struct signature 1", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_1.iris');
    ...
    test("Should show struct signature 2", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_2.iris');
        await test_signature_help(document_uri, new vscode.Position(21, 14), {
            signatures: [create_complex_struct_signature()],
            activeSignature: 0,
            activeParameter: 0
        });
    ...
    test("Should show struct signature 3", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_3.iris');
    ...
    test("Should show struct signature 4", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_4.iris');
    ...
    test("Should show struct signature 5", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_5.iris');
    ...
    test("Should show struct signature 6", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_6.iris');
        await test_signature_help(document_uri, new vscode.Position(15, 21), {
            signatures: [create_complex_struct_signature()],
            activeSignature: 0,
            activeParameter: 1
    ...
    test("Should show struct signature 7", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_7.iris');
    ...
    test("Should show struct signature 8", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_8.iris');
    ...
    test("Active parameter should be the member after the previous parameter name if nothing is written yet", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_9.iris');
    ...
    test("Active parameter should be the member whose name best matches what is being written", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_10.iris');
    ...
    test("Active parameter should show the member that already exists at the cursor 0", async () => {
        const document_uri = get_document_uri('projects/other/signature_help_struct_11.iris');
